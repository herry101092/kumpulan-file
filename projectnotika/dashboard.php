        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <a href="#"><img src="https://www.ryyulapak.com/~img/titanium_291218_feb_minggu_2-a5c4c-2545b_136785-t598_13.jpg" alt="" /></a>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="Tables" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                ...
                                <li><a href="data-table.html">Tambah Variabel</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="footer-copy-right">
                        <p>Copyright © 2019 
. All rights reserved. Template by <a href="https://www.ryyulapak.com/">Colorlib</a>.</p>
                    </div>
                </div>
            </div>
        </div>
