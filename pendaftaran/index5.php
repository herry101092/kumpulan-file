...
<body>
	<style>
	body {background-image: url("https://1.bp.blogspot.com/--tQk4ljZRhE/WfacX4egvjI/AAAAAAAAEWE/V2MDLCJ5b38flK8CBh180aAgVe7XkoFSQCLcBGAs/s400/mabes%2Btni.png");}
	</style>

<table border="4" bgcolor="A9C5EB" align="center" height="500" width="400" cellpadding="20">
<tr>
<td>
<b><font color="black" size="5"> Mendaftar Class Programer </font></b>
<p> Gratis, Untuk TNI/PNS </p>
<p><b> Nama Lengkap </b></p>
<input type="text" name="namadepan" size="20" placeholder="Nama Depan">
<input type="text" name="namabelakang" size="20" placeholder="Nama Belakang"><br><br>
<p><b> Pangkat </b></p>
<select name="Pangkat">
...
<br><br>
<input value="Kirim" style="background-color: 4985D0; height: 50; width: 150;"type="submit"  a href=<"https://tni-au.mil.id/konten/kohanudnas"></a>
 </li>
</td>
</tr>
